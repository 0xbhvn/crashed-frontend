...
export function ExpectedValuesWidget({ className }: BaseWidgetProps) {
	...
	const getRecommendationColor = (recommendation: string) => {
		if (recommendation.includes('Strongly favorable'))
										...
										<p className="text-2xl font-bold">
											{
												data.optimal_targets
													.max_expected_value.target
											}
										</p>
										<p className="text-sm text-muted-foreground">
											EV:{' '}
											{data.optimal_targets.max_expected_value.expected_value?.toFixed(
												2
											)}
										</p>
										<p className="text-xs text-muted-foreground">
											Prob:{' '}
											{data.optimal_targets.max_expected_value.probability?.toFixed(
												2
											)}
											%
										</p>
								...
								<Card>
									...
									<CardContent>
										<p className="text-2xl font-bold">
											{
												data.optimal_targets
													.max_kelly_criterion.target
											}
										</p>
										<p className="text-sm text-muted-foreground">
											Kelly:{' '}
											{data.optimal_targets.max_kelly_criterion.kelly_criterion?.toFixed(
												2
											)}
											%
										</p>
										<p className="text-xs text-muted-foreground">
											EV:{' '}
											{data.optimal_targets.max_kelly_criterion.expected_value?.toFixed(
												2
											)}
										</p>
									</CardContent>
								...
								<Card>
									...
									<CardContent>
										<p className="text-2xl font-bold">
											{
												data.optimal_targets
													.best_risk_adjusted.target
											}
										</p>
										<p className="text-sm text-muted-foreground">
											Score:{' '}
											{data.optimal_targets.best_risk_adjusted.risk_adjusted_score?.toFixed(
												2
											)}
										</p>
										<p className="text-xs text-muted-foreground">
															...
															{Object.entries(
																...
																([
																	...
																	>
																		...
																		<TableCell>
																			{analysis.empirical_probability.toFixed(
																				2
																			)}
																			%
																		</TableCell>
																		<TableCell className="text-muted-foreground">
																			{analysis.theoretical_probability.toFixed(
																				2
																			)}
																			%
																		</TableCell>
											...
											<CardContent>
												...
												<Alert className="mt-4">
													...
													<AlertDescription>
														...
														optimal bet sizing as a
														percentage of bankroll.
														Values are capped at 25%
														for safety. Never bet
															...
															([
																...
																>
																	<div>
																		...
																		<p className="text-xs text-muted-foreground">
																			Breakeven:{' '}
																			{analysis.breakeven_probability.toFixed(
																				2
																			)}
																			% |
																			Actual:{' '}
																	...
																	<div className="text-right">
																		...
																		>
																			Kelly:{' '}
																			{analysis.kelly_criterion.toFixed(
																				2
																			)}
																			%
																		</Badge>
																		<p className="text-xs mt-1">
																			EV/100:{' '}
																			{analysis.ev_per_100_bets >
																			0
																				? '+'
																				: ''}
																			{analysis.ev_per_100_bets.toFixed(
																				2
																			)}
																		</p>
																	</div>
													...
													{Object.entries(
														...
														>
															<div className="flex items-center justify-between mb-2">
																...
																>
																	{prob.conditional_probability.toFixed(
																		2
																	)}
																	%
																</Badge>
