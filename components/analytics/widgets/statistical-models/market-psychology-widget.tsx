		...
		<div className={className}>
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Advanced market sentiment analysis including Fear &
						Greed index, volatility regimes, and momentum indicators
					</CardDescription>
				</CardHeader>
						...
						<div className="space-y-2">
							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) =>
										setShortWindowInput(e.target.value)
									}
									placeholder="50"
									className="flex-1"
								/>
								<Input
									...
									onChange={(e) =>
										setLongWindowInput(e.target.value)
									}
									placeholder="200"
									className="flex-1"
								/>
									...
									<CardContent>
										...
										<div className="space-y-2">
											<div className="flex justify-between text-sm">
												...
												<span>
													{data.fear_greed_index.components.performance.toFixed(
														2
													)}
												</span>
											</div>
											...
											<div className="flex justify-between text-sm">
												...
												<span>
													{data.fear_greed_index.components.volatility.toFixed(
														2
													)}
												</span>
											</div>
											...
											<div className="flex justify-between text-sm">
												...
												<span>
													{data.fear_greed_index.components.high_multipliers.toFixed(
														2
													)}
												</span>
											</div>
											...
											<div className="flex justify-between text-sm">
												<span>
													Bust Frequency (inverted)
												</span>
												<span>
													{data.fear_greed_index.components.bust_frequency.toFixed(
														2
													)}
												</span>
											</div>
									...
									<CardContent>
										<div className="space-y-4">
											...
											<div>
												...
												<div className="space-y-2">
													{data.trading_recommendations.map(
														(rec, idx) => (
															<div
																key={idx}
										...
										<div className="space-y-2">
											<div className="flex items-baseline justify-between">
												<p className="text-2xl font-bold">
													{data.bust_frequency_index.index.toFixed(
														2
													)}
												</p>
												<Badge
												...
												>
													{
														data.bust_frequency_index.interpretation.split(
															' - '
														)[0]
													}
												</Badge>
											...
											<div className="space-y-1 text-xs">
												<div className="flex justify-between">
													...
													<span>
														{data.bust_frequency_index.recent_bust_rate.toFixed(
															2
														)}
														%
													</span>
												...
												<div className="flex justify-between">
													...
													<span>
														{data.bust_frequency_index.long_term_bust_rate.toFixed(
															2
														)}
														%
													</span>
										...
										<div className="space-y-2">
											{data.volatility_regime.error ? (
												...
												<>
													<div className="flex items-baseline justify-between">
														<p className="text-2xl font-bold">
															{data.volatility_regime.current_volatility.toFixed(
																2
															)}
														</p>
														<Badge>
													...
													<div className="space-y-1">
														<div className="flex justify-between text-xs">
															...
															<span>
																{data.volatility_regime.percentile_rank.toFixed(
																	2
																)}
																%
															</span>
													...
													<div className="space-y-1 text-xs">
														<div className="flex justify-between">
															...
															<span>
																{data.volatility_regime.volatility_ratio.toFixed(
																	2
																)}
															</span>
														</div>
														<div className="flex justify-between">
															...
															<span>
																{data.volatility_regime.average_volatility.toFixed(
																	2
																)}
															</span>
														</div>
											...
											{data.momentum_indicators.error ? (
												...
												<>
													<div className="flex items-baseline justify-between">
														<div>
															<p className="text-2xl font-bold">
																{data.momentum_indicators.rsi.toFixed(
																	0
																)}
															</p>
													...
													<div className="space-y-1 text-xs">
														<div className="flex justify-between">
															...
															>
																...
																0
																	? '+'
																	: ''}
																{data.momentum_indicators.momentum_score.toFixed(
																	2
																)}
																%
															</span>
														...
														<div className="flex justify-between">
															...
															<span>
																{data.momentum_indicators.recent_average.toFixed(
																	2
																)}
																x
															</span>
