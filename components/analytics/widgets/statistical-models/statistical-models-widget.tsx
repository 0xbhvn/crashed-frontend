...
import { BarChart3, Target, Brain, Calculator, Activity, AlertCircle } from 'lucide-react';
		...
		<div className={className}>
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Advanced statistical analysis specifically designed for BC.game crash mechanics, providing actionable insights for risk management and strategy optimization
					</CardDescription>
				</CardHeader>
				<CardContent>
					<Alert className="mb-6">
						...
						<AlertDescription>
							These models are designed specifically for BC.game's crash distribution. All recommendations are based on historical data and do not guarantee future results. Always gamble responsibly.
						</AlertDescription>
					</Alert>
					...
					<Tabs defaultValue="risk-metrics" className="w-full">
						<TabsList className="grid w-full grid-cols-2 lg:grid-cols-4">
							...
							<TabsTrigger value="expected-values" className="flex items-center gap-2">
								<Calculator className="h-4 w-4" />
								<span className="hidden sm:inline">Expected Values</span>
